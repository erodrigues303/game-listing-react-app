        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-5'>
                {sortedGames.map((item) => (
                    <div
                        key={item.id}
                        className='bg-[#76a8f75e] p-4 rounded-lg h-[400px] hover:scale-105 transition-all ease-in-out duration-300 cursor-pointer'
